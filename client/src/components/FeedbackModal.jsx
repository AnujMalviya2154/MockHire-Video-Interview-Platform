      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-4">
                ...
                >
                  <svg
                    ...
                    className={`h-7 w-7 transition-[fill,transform] duration-150 ease-[var(--ease-out-quart)] group-active:scale-90 ${
                      shown >= n ? "scale-100 fill-warn-500" : "fill-ink-200"
                    } ${hovered >= n ? "scale-110" : ""}`}
                  >
        ...
        <Field label="Verdict">
          <SegmentedChoice
            ...
            onChange={setResult}
            options={[
              { value: "pass", label: "Pass", hint: "Moving forward", activeText: "text-ok-strong" },
              { value: "fail", label: "Fail", hint: "Not this time", activeText: "text-bad-strong" },
            ]}
          />
        </Field>
